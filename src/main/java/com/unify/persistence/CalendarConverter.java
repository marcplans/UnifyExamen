...
public class CalendarConverter extends TypeConverter
	...
	public Object encode(Object val, MappedField optionalExtraInfo) {
        ...
        // . timeZone.getOffset(millis) - timeZone.getOffset(newMillis)  
        //   may not be 0 (if we're close to DST limits)
	...
	@Override
	public Object decode(Class type, Object o, MappedField mf)
