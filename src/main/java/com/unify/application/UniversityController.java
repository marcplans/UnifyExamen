...
public class UniversityController {
	...
	public UniversityDTO createUniversity(String uniId)
	...
	private void checkUniNotExists(String uniId)
			throws UniversityAlreadyExistsException,
			InvalidParamException {
	...
	University getUniversity(String uniId)
	...
	void saveUniversity(University uni)
			throws InvalidParamException, ResourceNotFoundException {
