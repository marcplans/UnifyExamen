...
public class SongController {
	...
	public SongDTO getCurrentSong(String uniId)
			throws NoSongToPlayException, InvalidParamException,
	...
	public SongDTO setCurrentSong(String uniId, SongDTO currentSong)
	...
	public void addSongsToUniversity(String uniId, SongDTO song)
			throws InvalidParamException, ResourceNotFoundException {
		
		University uni = uniController.getUniversity(uniId);

		Song s = new Song(song.getTitle(), song.getArtist(),
				song.getDuration(), song.getSongUrl(),
				song.getImageUrl());
		uni.addSong(s);
	...
	public List<Song> getAllSongs(String uniId)
			throws InvalidParamException, ResourceNotFoundException {
