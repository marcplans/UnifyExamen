...
public class SongRestController {
	...
	public String getCurrentSong(@PathVariable String uniId)
			throws UniversityAlreadyExistsException,
			NoSongToPlayException, InvalidParamException,
	...
	public String playSong(@PathVariable String uniId,
			@RequestBody String jSong)
			throws InvalidParamException, ResourceNotFoundException,
			JsonSyntaxException, InvalidActionException {
	...
	public void addSongInUniversity(@PathVariable String uniId,
			@RequestBody String jSong)
			throws InvalidParamException, ResourceNotFoundException {
	...
	public String getAllSongs(@PathVariable String uniId)
			throws UniversityAlreadyExistsException,
			NoSongToPlayException, InvalidParamException,
			ResourceNotFoundException {
