...
public class University {
	...
	public void setCurrentSong(Song song)
			throws InvalidParamException, InvalidActionException {
		if (song == null)
	...
	// Added condition to check if current song is null,
	// if so, throws NoSongToPlayException
	...
	public Song getSong(SongDTO song)
