...
public class ListenCurrentSongTests extends AbstractTests {
	// FEATURE: As a user, I want to listen to my university's current
	// song, so I can discover awesome music.
	...
	@Given("^\"([^\"]*)\" is playing:$")
	public void is_playing(String uniId, List<SongDTO> songs)
			throws Throwable {
		clearBBDD();
	...
	public void user_searches_for_university_current_song(
	...
	public void will_return_a_song(List<SongDTO> songs)
			throws Throwable {
		SongDTO song = songs.get(0);
		assertThat("Song not correct ",
	...
	public void is_not_playing_any_song(String uniId)
			throws Throwable {
		clearBBDD();
	...
	public void user_searches_for_university_s_current_song(
			String uniId) throws Throwable {
	...
	public void not_Found_error_will_be_returned() throws Throwable {
		assertThat(
				"Not found (404) error after asking for current song",
				responseCode == 404);
	}
	...
	public void is_playing_a_song(String uniId, List<SongDTO> songs)
			throws Throwable {
		clearBBDD();
	...
	public void system_waits_for_seconds(int seconds)
			throws Throwable {
		Thread.sleep(seconds * 1000);
	}

	@When("^user searches for \"([^\"]*)\" song$")
	public void user_searches_for_song(String uniId)
			throws Throwable {
		responseCode = service.getCurrentSongResponseCode(uniId);
	}
	...
	public void not_Found_error_will_be_shown() throws Throwable {
		assertThat("Should return a not found (404) error. But is "
