...
public class AbstractTests {
	...
	protected UniversityDTO tryToCreateUniversity(String uniId)
			throws InterruptedException, ExecutionException {

		Future<UniversityDTO> result = service
				.createUniversity(uniId);
		return result.get();
	}

	protected SongDTO searchForCurrentSong(String uniId)
			throws InterruptedException, ExecutionException {
	...
	protected List<SongDTO> getAllSongsUniversity(String uniId)
			throws InterruptedException, ExecutionException {
