...
public class LookupServiceTesting {
	...
	public Future<SongDTO> getCurrentSong(String uniId) {
		...
		String result = restTemplate.getForObject(
				urlEndpoint + "{uniId}/songs/current/", String.class,
				params);
		Gson gson = new GsonBuilder().create();
		return new AsyncResult<SongDTO>(
				gson.fromJson(result, SongDTO.class));
	}
	...
	public void playSong(String uniId, SongDTO song) {
		Map<String, String> params = new HashMap<String, String>();
		params.put("uniId", uniId);
		restTemplate.put(urlEndpoint + "{uniId}/songs/current",
				toJson(song), params);
	}
	...
	public int getCurrentSongResponseCode(String uniId) {
		...
		ResponseEntity<String> response = restTemplate.exchange(
				urlEndpoint + "{uniId}/songs/current/",
	...
	// suppress type safety warning for method put(Object, Object)
	@SuppressWarnings("unchecked")
	@Async
	public Future<UniversityDTO> createUniversity(String uniId) {
		JSONObject json = new JSONObject();
		json.put("uniId", uniId);
		String result = restTemplate.postForObject(urlEndpoint, json,
				String.class);
		return new AsyncResult<UniversityDTO>(
				new Gson().fromJson(result, UniversityDTO.class));
	}
	...
	public Future<List<SongDTO>> getAllSongs(String uniId) {
		...
		params.put("uniId", uniId);
		String result = restTemplate.getForObject(
				urlEndpoint + "{uniId}/songs/", String.class, params);
		Gson gson = new GsonBuilder().create();
		List<SongDTO> songs = Arrays
				.asList(gson.fromJson(result, SongDTO[].class));
	...
	public void addSongInUniversity(SongDTO song, String uniId) {
		Map<String, String> params = new HashMap<String, String>();
		params.put("uniId", uniId);
		restTemplate.postForEntity(urlEndpoint + "{uniId}/songs/",
				toJson(song), String.class, params);

	}

	@Async
	public int addSongsInUniversityResponseCode(SongDTO song,
			String uniId) {
		Map<String, String> params = new HashMap<String, String>();
		params.put("uniId", uniId);
		removeErrorHandlerRestTemplate();
		...
		ResponseEntity<String> response = restTemplate.postForEntity(
				urlEndpoint + "{uniId}/songs/", toJson(song),
				String.class, params);
		restTemplate = new RestTemplate();
		return response.getStatusCode().value();
	}
